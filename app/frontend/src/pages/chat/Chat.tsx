                    ...
                    <div className={styles.chatContainer}>
                        {!lastQuestionRef.current ? (
                            <div className={styles.chatEmptyState}>
                                <SparkleFilled fontSize={"120px"} primaryFill={appConfig.Layout.Headercolor.value} aria-hidden="true" aria-label="Chat logo" />
                                <h1 className={styles.chatEmptyStateTitle}>{appConfig.Layout.PageBodyHeading.value}</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>{appConfig.Layout.PageBodySubHeading.value}</h2>
                        ...
                        <div className={styles.chatInput}>
                            <QuestionInput
                                clearOnSend
                                placeholder={appConfig.Layout.Placeholder.value}
                                disabled={isLoading}
